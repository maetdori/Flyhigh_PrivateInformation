...
public class APIException extends Exception {
    ...
    static public final int NO_INTERNET = 0x01;

    //DatabaseManager
    static public final int CLASS_DATABASEMANAGER = 0x80010000;
    //Methods
    ...
    static public final int SQL_INSERT_ERR = 0x06;
    static public final int DB_NO_DATA = 0x07;
